...
SELECT 
    u.USER_ID::VARCHAR(255) AS user_id,
    u.FIRST_NAME::VARCHAR(255) AS first_name,
    u.LAST_NAME::VARCHAR(255) AS last_name,
    CASE 
    ...
    u.PREFERRED_LANGUAGE::VARCHAR(255) AS preferred_language,
    ...
    u.ACCOUNT_STATUS::VARCHAR(255) AS account_status,
